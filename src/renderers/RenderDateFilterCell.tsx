...
class RenderDateFilterCell extends Component<RendererProps> {
    ...
    render() {
        if (this.props.tableData.props !== undefined) {
            let endDate = this.props.tableData.props.searchInfo[
                this.props.columnId
            ]?.endDate;
            let startDate = this.props.tableData.props.searchInfo[
                this.props.columnId
            ]?.startDate;
            ...
            const startDatePicker = (
                <DatePicker
                    ...
                    onChange={(eventStartDate: moment.Moment | null) => {
            ...
            const endDatePicker = (
                <DatePicker
                    ...
                    onChange={(eventEndDate: moment.Moment | null) => {
